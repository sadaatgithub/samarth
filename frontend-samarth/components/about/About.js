...
const About = () => {
  return (
    <div className="px-20 flex items-center justify-center flex-col text-center [&>p]:text-slate-500">
      ...
      <p className="mt-10 leading-8 px-20 text-lg">
      ...
      <p className="leading-8 px-20 mt-5 text-lg"> Molestiae impedit consectetur inventore
