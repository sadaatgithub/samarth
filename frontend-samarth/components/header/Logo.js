...
const Logo = ({visible}) => {
  return (
    ...
    <Image src={logoPng} width={70} height={70} alt="logo" className="translate-y-2 -translate-x-5"/>
     ...
     <h1 className="-translate-x-5 flex flex-col text-left text-teal-500 "> Samarth <span className="text-slate-500 text-sm font-semibold">Physiotherapy & Rehab Clinic</span></h1></Link></div>
