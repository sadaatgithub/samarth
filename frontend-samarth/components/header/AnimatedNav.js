...
const AnimatedNav = ({visible,setBurgerMenuState,burgerMenuState}) => {
  ...
  return (
    <div className={`${visible? "top-0 opacity-100 transition-all duration-500 ease-in-out ":"-top-24 opacity-0"}  md:flex fixed  shadow-md left-0 right-0 z-[103] px-2 lg:px-14 bg-white max-w-[1440px] mx-auto`}>
