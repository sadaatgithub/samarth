...
const AppointmentBanner = () => {
  ...
  return (
    ...
    <div className="h-52 w-full flex bg-gradient-to-l from-teal-500 to-teal-600 overflow-hidden mt-40 items-center justify-around rounded-lg md:flex-row flex-col relative">
        <h3 className="text-xl text-center md:text-3xl w-2/3 md:font-bold text-gray-50 md:w-1/2 z-[1]">"Get back on track with expert physiotherapy to help you move, feel, and live better."</h3>
        <button
