...
// md:bg-[url('../public/slide2.jpg')] after:bg-gradient-to-l after:from-teal-600/50 after:to-transparent
  return (
    ...
    >
      ...
      <h2 className="text-3xl  lg:text-4xl font-black text-slate-600 z-[1] lg:leading-[52px] ">
        Welcome to Samarth Physiotherapy & Rehabilitition clinic
      </h2>
      <h3 className="text-xl  font-semibold z-[1] text-gray-500 lg:w-3/4 sm:w-2/3 w-full text-center lg:text-left">
      ...
      <div className=" hidden lg:flex md:w-1/5  h-[300px] lg:w-2/5 aspect-square rounded-md  z-10 relative self-center grow">
        ...
        <Image src={heroImage2} width={320} height={240} alt="" className="absolute hidden lg:block -left-28 shadow-2xl object-right -bottom-20 w-1/3 z-[1] h-1/3 object-cover rounded-xl  shadow-green-900/20"/>
        <Image src={heroImage2} width={320} height={240} alt="" className="absolute hidden lg:block -left-10 z-[1] shadow-2xl h-1/3 object-cover shadow-green-900/20 -top-16 w-1/3 rounded-xl"/>
      </div>
    </div>
  );
};
