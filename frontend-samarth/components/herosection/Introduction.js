    ...
    >
     ...
     <div 
       className={` flex flex-col relative w-full md:w-7/12 justify-center text-left  md:items-start `}>
        ...
        <m.div variants={textVariant(0.6)} initial="hidden" whileInView="show" className="flex flex-col sm:flex-row gap-4 mt-12 [&>button]:uppercase  items-center sm:items-start justify-start w-full">
