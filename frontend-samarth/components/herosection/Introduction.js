...
const Introduction = () => {
  ...
  return (
    ...
    after:absolute after:inset-0 after:bg-gradient-to-l after:from-teal-600/50 after:to-transparent  text-center md:text-left">
        <h1 className="text-3xl lg:text-5xl font-bold text-slate-800 z-[1] lg:leading-[72px] drop-shadow-lg">Welcome to Samarth Physiotherapy <br/>& Rehabilitition clinic</h1>
