    ...
    >
     ...
     <div 
       className={` flex flex-col relative w-full md:w-7/12 justify-center text-left  md:items-start `}>
        <m.p variants={textVariant(0)} className={` font-semibold text-rose-500`}>Welcome to</m.p>
        <m.h2 variants={textVariant(0.1)} className={` text-3xl md:text-5xl font-bold text-sky-900 mt-4`}>
          Samarth Physiotherapy & 
          Rehab Care Unit
        </m.h2>
        <m.div variants={textVariant(0.2)} className="hidden w-2/3  justify-center">
        <Underline/>
        </m.div>
        <m.p variants={textVariant(0.3)} className="text-lg mt-6  text-sky-800 md:w-11/12 first-letter:text-2xl">
        ...
        <m.p variants={textVariant(0.4)} className="text-xl text-sky-900 font-semibold mt-8">
          Our Features
        </m.p>
        <m.div variants={textVariant(0.5)} className="flex md:gap-6 flex-col md:flex-row">
        ...
        <m.div variants={textVariant(0.6)} className="flex flex-col sm:flex-row gap-4 mt-12 [&>button]:uppercase  items-center sm:items-start justify-start w-full">
          <button className="text-teal-600 w-full  sm:w-auto max-w-xs rounded-sm px-6 py-3 tracking-wider  border border-teal-800 bg-white  hover:text-white  hover:bg-teal-800 transition-all duration-300">
