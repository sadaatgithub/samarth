...
const Introduction = () => {
  ...
  return (
    ...
    >
      <h1 className="text-3xl  lg:text-5xl font-bold text-slate-700 z-[1] lg:leading-[60px] drop-shadow-lg ">
        Welcome to Samarth Physiotherapy <br />& Rehabilitition clinic
      </h1>
      <h4 className="text-xl lg:text-2xl font-bold z-[1] text-slate-700 ">
      ...
      <button
        className="mt-10 md:mt-0 flex justify-center items-center gap-4 md:text-xl bg-teal-500 z-[1] group text-white px-9 py-4 rounded-full shadow-2xl  hover:bg-teal-800 focus:bg-teal-800 transition-all duration-100"
