...
[&>div>h3]:text-2xl [&>div>h3]:font-bold [&>div>h3]:text-slate-600 [&>div>p]:text-slate-500 [&>div>p]:text-base md:px-10 text-justify md:[&>div]:w-1/3">
    ...
    <p className="">At Samarth, we have built a reputation as the most trusted provider of physiotherapy services in the community. Our team of highly skilled and experienced therapists is dedicated to providing personalized and effective care to each and every patient.</p>
        </div>
        <div className="flex flex-col">
    <TbPhysotherapist/>
    <h3>Expert Therapist</h3>
    <p className="">Our team of expert therapists at Samarth is dedicated to providing the highest quality physiotherapy services to our patients. With a focus on personalized treatment plans and hands-on care, our therapists are committed to helping patients achieve their best possible outcomes.</p>
        </div>
</div>
  )
}
