...
md:[&>div>h3]:text-2xl [&>div>h3]:text-lg [&>div>h3]:font-bold [&>div>h3]:text-slate-600 [&>div>p]:text-gray-500 [&>div>p]:text-base md:px-20 text-justify lg:[&>div]:w-1/3
border mt-6 border-gray-200"
    >
