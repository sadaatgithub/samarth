...
const FreeConsultation = ({ setOpen }) => {
  ...
  return (
    <m.div
      ...
      className="fixed top-0 w-full h-full flex flex-col  justify-center items-center bg-black/70 backdrop-blur-sm z-[1000] py-10"
    >
      <FaTimes
      ...
      {isSuccess ? (
        ...
        >
          {error && <div className={` ${error ? "top-0 transition-all duration-300" : "-top-12 "} 
