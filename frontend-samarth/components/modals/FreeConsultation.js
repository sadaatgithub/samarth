...
const FreeConsultation = ({ setOpen }) => {
  ...
  return (
    ...
    <div className="fixed top-0 w-full h-full flex flex-col  justify-center items-center bg-black/60 z-[1000] py-10">
 ...
 <div className="w-[90%] lg:w-2/5 bg-white px-4 md:px-16 py-6 text-slate-700 rounded-md  text-center flex items-center justify-center flex-col gap-6">
  ...
  <br/> We will get back to you soon..!</p>
      ...
      >
        ...
        <h3 className="text-center text-2xl font-semibold text-gray-700">Appointment Form</h3>
          <h5 className="text-sm md:text-base">Please fill the required details. <span className="font-semibold text-blue-600">We will contact you soon</span></h5>
